...
public class DataClassPremium {
    ...
    public DataClassPremium(){

    }

    public DataClassPremium(String recipe_name, String recipe_ingredient, String recipe_time, String recipe_photo, String recipe_serving, String recipe_calories, String recipe_video, String recipe_category, String recipe_direction, String recipe_user, float recipe_rating) {
