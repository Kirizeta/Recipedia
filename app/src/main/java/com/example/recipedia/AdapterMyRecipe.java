...
public class AdapterMyRecipe extends RecyclerView.Adapter<AdapterMyRecipe.MyViewHolder> {

    private Context context;
    private List<DataClass> dataList;

    public AdapterMyRecipe(Context context, List<DataClass> datalist) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, DetailMyRecipe.class);
